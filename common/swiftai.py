...
import numpy as np
from common.process_data import preprocess
from common.constants import DATA_LOCATION, SAVE_LOCATION, TEMPERATURES
...
class SwiftAI:
    ...
    def generate_songs(self, model, preset_seed, song_length=176, filename='songs.txt'):
        """
